...
// которые стоят по 3000 кредитов за штуку.Цена одного дроида хранится в переменной 
// pricePerDroid(создай и присвой).

// При посещении страницы, используя prompt, н
// еобходимо спросить количество дроидов которые пользователь хочет купить и 
...
// let order = prompt('Укажите количество дронов которое хотите купить');
// let totalPrice; 
// let remainder;
...
//      console.log(`Вы купили ${order} дроидов, на счету осталось ${remainder} кредитов.`);
//     }
// }
